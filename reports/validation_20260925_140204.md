...
Generated 20260925_140204 · runtime 1263.4 s
...
| Answer scoring Spearman rho | 0.979 | ≥ 0.8 | PASS |
...
| OTP digit uniformity p-value | 0.073 | ≥ 0.05 | PASS |
...
85 short-answer cases, 6 MCQ cases.

* Band accuracy: 100.0%
* Spearman ρ: 0.979 · Pearson r: 0.997
* MAE vs target: 1.0 points
* Correct ordering (full > partial > off-topic): 100.0%
* MCQ accuracy: 100.0%

_Synthetic answers per question: explains all key concepts / explains half / bare keyword list (should be capped at 50) / off-topic / empty. Measures rubric scoring consistency without the AI grader; paraphrases without the key terms need the AI grader (see the ai_guards suite)._

## Code judge

57 problems, 229 submissions · accuracy 100.0% · false accepts 0 · false rejects 0 · mean 4119 ms
...
* 100,000 codes sampled; digit χ² = 15.70 (p = 0.073)
* Entropy: 3.3219 bits/digit (19.93 bits/code, max 19.93)
* Duplicates: 4880 (expected 4837.4 for a uniform generator)
* Brute-force success chance per issued code: 0.0005%
* Issue 3.9 ms · verify 8.0 ms (mean)
